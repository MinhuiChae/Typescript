...
const amountDiscountPolicy = new AmountDiscountPolicy(discountMoney, [sequenceCondition, periodCondition]);
...
const screeing = new Screening(movie, 5, 12, "화요일");
console.log(screeing.reserve(customer, 2));
