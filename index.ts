...
const amountDiscountPolicy = new AmountDiscountPolicy(discountMoney, [ periodCondition, sequenceCondition], false);
...
const result1 = screeing.reserve(customer1, 2);
console.log(result1);
...
const result2 = secondScreening.reserve(customer2, 1);
console.log(result2);
